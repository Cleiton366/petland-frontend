  ...
  return (
    <Container user={user}>
      ...
      <div className={styles.requests}>
        ...
        <div className={styles.pedido} donationrequestid="62b21948afe9a">
          <div className={styles.perfil2} interresteddoneeid="62b21d606d889">
          ...
          <p>
            <span petid="62b21ad8b34ac">wants to adopt PetName</span>
          </p>
          <div className="botoes">
            <button type="submit" className={styles.Accept} onClick={aceitar}>Accept</button>
            <button type="submit" className={styles.Reject} onClick={deletar}>Reject</button>
          </div>
        </div>

        <div className={styles.pedido} donationrequestid="62b2197182eff">
          <div className={styles.perfil2} interresteddoneeid="62b21d98a8907">
          ...
          <p>
            <span petid="62b21af762a06">wants to adopt PetName</span>
          </p>
          <div>
            <button type="submit" className={styles.Accept} onClick={aceitar}>Accept</button>
            <button type="submit" className={styles.Reject} onClick={deletar}>Reject</button>
        ...
        <div className={styles.pedido} donationrequestid="62b219846b6d3">
          <div className={styles.perfil2} interresteddoneeid="62b21da4bc3c0">
          ...
          <p>
            <span petid="62b21be08decf">wants to adopt PetName</span>
          </p>
          <div>
            <button type="submit" className={styles.Accept} onClick={aceitar}>Accept</button>
            <button type="submit" className={styles.Reject} onClick={deletar}>Reject</button>
        ...
        <div className={styles.pedido} donationrequestid="62b2199c81c97">
          <div className={styles.perfil2} interresteddoneeid="62b21db348152">
          ...
          <p>
            <span petid="62b21c328142f">wants to adopt PetName</span>
          </p>
          <div>
            <button type="submit" className={styles.Accept} onClick={aceitar}>Accept</button>
            <button type="submit" className={styles.Reject} onClick={deletar}>Reject</button>
        ...
        <div className={styles.pedido} donationrequestid="62b219b66fce0">
          <div className={styles.perfil2} interresteddoneeid="62b21df9b17ce">
          ...
          <p>
            <span petid="62b21c3f864f6">wants to adopt PetName</span>
          </p>
          <div>
            <button type="submit" className={styles.Accept} onClick={aceitar}>Accept</button>
            <button type="submit" className={styles.Reject} onClick={deletar}>Reject</button>
        ...
        <div className={styles.pedido} donationrequestid="62b21e095a238">
          <div className={styles.perfil2} interresteddoneeid="62b21e112072a">
          ...
          <p>
            <span petid="62b21c6c1ef21">wants to adopt PetName</span>
          </p>
          <div>
            <button type="submit" className={styles.Accept} onClick={aceitar}>Accept</button>
            <button type="submit" className={styles.Reject} onClick={deletar}>Reject</button>
        ...
        <div className={styles.pedido} donationrequestid="62b219d681c22">
          <div className={styles.perfil2} interresteddoneeid="62b21e1ec1012">
          ...
          <p>
            <span petid="62b21c8824691">wants to adopt PetName</span>
          </p>
          <div>
            <button type="submit" className={styles.Accept} onClick={aceitar}>Accept</button>
            <button type="submit" className={styles.Reject} onClick={deletar}>Reject</button>
        ...
        <div className={styles.pedido} donationrequestid="62b21a06d18a8">
          <div className={styles.perfil2} interresteddoneeid="62b21e2e4a4bc">
          ...
          <p>
            <span petid="62b21ca2b7af9">wants to adopt PetName</span>
          </p>
          <div>
            <button type="submit" className={styles.Accept} onClick={aceitar}>Accept</button>
            <button type="submit" className={styles.Reject} onClick={deletar}>Reject</button>
        ...
        <div className={styles.pedido} donationrequestid="62b21a1c5fe5d">
          <div className={styles.perfil2} interresteddoneeid="62b21e46c3beb">
          ...
          <p>
            <span petid="62b21cba4e89b">wants to adopt PetName</span>
          </p>
          <div>
            <button type="submit" className={styles.Accept} onClick={aceitar}>Accept</button>
            <button type="submit" className={styles.Reject} onClick={deletar}>Reject</button>
